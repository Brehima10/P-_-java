    ...
    <title>projet1</title>
        ...
        <body>
           ...
           Matricule : <input type="text" name="matricule" placeholder="votre matricule" required></br><br />
               Nom: <input type="text" name="prenom" placeholder="votre prenom" required></br><br />
               Prenom: <input type="text" name="nom" placeholder="votre nom" required></br><br />
                <label >sexe:</label>  
	            <input type="radio" name="sexe" value="masculin" /> masculin  
	            <input type="radio" name="sexe" value="femini" /> feminin</br><br />
                adresse: <textarea rows="2" cols="15" wrap="physique" name="adresse"></textarea><br /><br />
